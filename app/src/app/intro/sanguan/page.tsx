...
const SUB_PAGES = [
  { title: "经文原文", desc: "在线阅读链接汇总", href: "/intro/sanguan/scripture", icon: BookOpen },
  { title: "经文注解", desc: "注解与导读", href: "/intro/sanguan/commentary", icon: FileText },
  { title: "诵经音频", desc: "跟随道长诵念", href: "/intro/sanguan/audio", icon: Music },
];

export default function SanguanPage() {
  return (
    <motion.div
