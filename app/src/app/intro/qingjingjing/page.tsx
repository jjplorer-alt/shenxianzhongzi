...
const SUB_PAGES = [
  {
    title: "经文原文",
    desc: "在线阅读《太上老君说常清静经》全文",
    href: "/intro/qingjingjing/scripture",
    icon: BookOpen,
  },
  {
    title: "经文注解",
    desc: "侯善渊、林子等多家注本，识典古籍在线阅读",
    href: "/intro/qingjingjing/commentary",
    icon: FileText,
  },
];
...
export default function IntroQingjingjingPage() {
  return (
    <motion.div
