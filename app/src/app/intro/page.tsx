    ...
    >
      <motion.div variants={fadeUp}>
        ...
        <p className="mt-2 text-[13px] leading-relaxed text-muted-foreground">
         道教经典浩如烟海，本页展示的均为当下广为流传、适合入门阅读的典籍。部分经文提供注解和唱诵音频。
        </p>
      </motion.div>
          ...
          >
            <div className="grid gap-1 p-2 sm:grid-cols-2">
              {group.items.map((item) => {
                ...
                const className =
                  "group flex items-center justify-between gap-3 rounded-lg px-3 py-2.5 transition-all duration-200 hover:bg-white/[0.04] hover:pl-4";
