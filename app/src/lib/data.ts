...
export const DAOJING_QA: IntroQA[] = [
  ...
  {
    q: "不是道教信徒可以诵读道经吗？",
    a: [{ t: "可以。玄门四品经等经文多开示「凡有男女」均可朝礼，不限信仰。只需保持恭敬心、清净身心即可。" }],
  },
  {
    q: "有没有道经不能随便读？",
    a: [
      { t: "部分传统说法中，确有「某经需师传」「某时不宜诵」等讲究，多与科仪传承、择日择时有关。但本站所涉玄门四品经、" },
      ...
      { t: "等，均为广为流传的入门经典，经中多称「普度众生」「凡有男女」可诵，一般人均可恭敬诵读。若有特殊顾虑（如特定传承要求），可咨询当地宫观或道长得明确解答。" },
    ],
  },
  /* ── 诵经方法与习惯 ── */
  {
