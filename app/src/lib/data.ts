...
export const DAOJING_QA: IntroQA[] = [
  /* ── 入门与资格 ── */
  {
    ...
    a: [
      { t: "不必。道经是「公器」，任何人都可以阅读学习。皈依是修行路径的选择，而非阅读许可。只需保持恭敬心、清净身心即可，不限信仰。" },
    ],
  },
  {
    q: "读道经能解决现实问题（焦虑/事业/感情）吗？",
    a: [
      { t: "能这样问，说明你心里正承受着不少。道经不是许愿咒语，无法一读就让焦虑消散、事业翻身。但它能给你的，是另一种力量：当你慢慢学着用它的眼光看自己、看世事，心会渐渐稳下来，遇事不再那么慌张。不是问题消失了，而是你变了——这份改变需要时间，需要静下心来慢慢读、慢慢体会，但值得。" },
    ],
  },
  {
    q: "生活在现代、讲科学的人，读道经会不会格格不入？",
    a: [
      { t: "不会。道经讲的是生命的规律与处世的智慧，与科仪礼神一样，都是修行的一部分。不少现代人读" },
      { l: "道德真经", href: "https://www.daorenjia.com/daozang15-649" },
      { t: "、" },
      { l: "清静经", href: "/intro/qingjingjing" },
      { t: "，反而在信息过载、节奏飞快的生活里找到一方清净，技术焦虑也能缓一缓。" },
    ],
  },
  {
    ...
    a: [
      ...
      { t: "（特定经典）。本站「道经入门」提供这四部的经文原文、注解、诵经音频。北京白云观" },
  ...
  {
    q: "自学读经需要经济投入吗？必须请经本吗？",
    a: [
      { t: "基础经典网上有权威电子版（如" },
      { l: "识典古籍", href: "https://www.shidianguji.com" },
      { t: "、" },
      { l: "中华典藏", href: "https://www.zhonghuadiancang.com" },
      { t: "），纸质本几十元即可。所谓「请经」重在恭敬心，非价格高低。" },
    ],
  },
  {
    q: "有没有道经不能读、不允许阅读？",
  ...
  /* ── 好奇观望 ── */
  {
    q: "看不懂文言文/经文读不懂怎么办？",
    a: [
      { t: "先读白话注解版建立理解，再对照原文。不要卡在字句上，重点是「口诵心惟」，音韵本身就有调息作用。本站各经均有「经文注解」栏目。早晚功课经可参阅" },
  ...
  },
  {
    ...
    a: [
      ...
      { t: "、" },
      { l: "道德真经", href: "https://www.daorenjia.com/daozang15-649" },
      { t: "）是心性指引，不易走偏。涉及符咒、存思等实修内容才需师承。初学以「读」为主，而非「修」。" },
    ],
  },
  {
    q: "网络上的道经资源可靠吗？哪里找权威版本？",
    a: [
      { t: "推荐：" },
      { l: "中华典藏", href: "https://www.zhonghuadiancang.com" },
      { t: "道藏部、" },
      { l: "识典古籍", href: "https://www.shidianguji.com" },
      { t: "、中国哲学书电子化计划、权威出版社纸质书（中华书局、宗教文化出版社）。本站" },
      { l: "资源索引", href: "/resources" },
      { t: "汇集可靠链接。避免来路不明的「秘传」版本。" },
    ],
  },
  /* ── 诵经方法与习惯 ── */
  {
    q: "诵经需要什么准备？有什么注意事项？",
    a: [
      { t: "心诚为上。基础礼仪：净手、端坐、静心三分钟即可。理想可加净口、衣着整洁、选安静处所、焚一柱香（无香炉可用清水或心香代替）。持诵时心念专一、字句清晰。不必纠结形式，但保持仪式感有助于进入状态。本站" },
      { l: "早坛", href: "/intro/zaotan" },
      { t: "、" },
      { l: "晚坛", href: "/intro/wantan" },
      { t: "、" },
      { l: "三官", href: "/intro/sanguan" },
      { t: "、" },
      { l: "北斗", href: "/intro/beidou" },
  ...
  {
    q: "诵读道经有哪些方法？每天需要读多久？必须出声吗？",
    a: [
      { t: "初学 10—15 分钟即可，贵在坚持。默念亦可，但初学者出声更易摄心（防止走神），音韵振动本身有养生效果。按是否出声分：音诵（出声）与默诵；按是否看经本分：看诵与讽诵（背诵）。龙虎法脉" },
  ...
  },
  {
    q: "每天应该诵几遍？什么时间诵读最好？",
    a: [
      { t: "初学每日一遍即可，熟悉后可增至三遍或七遍。传统建议清晨（卯时）或晚间（亥时），但能坚持的固定时间就是最好的时间。" },
    ],
  },
  {
    q: "不同版本的字句有差异，以哪个为准？",
    a: [
      { t: "以明《正统道藏》或当代权威校注本为准。日常诵读选流通广的版本，不必过度考据。" },
    ],
  },
  {
    q: "读经时走神、犯困是业障吗？",
