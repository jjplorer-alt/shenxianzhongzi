...
学道之人，当学经书。当今网络发达、学习资源无数，看似便利，但就我亲身体验而言，各种资源散落于公众号、B站、微信群、独立网站、音乐软件、网盘……或不便寻找、或不便传递、或错字、或攀缘附会、或不便展示长篇内容、或容易被删。

省流就是：不好找、不好用。

于是我想做一个资源聚合索引网站，设想如下：
「核心理念」：内容实用、精简、包容、新手友好，界面清爽、结构清晰、浏览舒适、加载快速。
「运营定位」：只做高质量内容的搬运工。无广告、免费使用。
「使命」：展示道教文化，减少误解与偏见。
「愿景」：如有朋友对道教文化感兴趣、好奇，这个网站可省去千言万语、助其少走弯路。
「命名」：网站名为“神仙种子”，主要是为了朗朗上口，方便大家轻松找到本站。

“神仙种子”是什么意思呢？《度人经》曰：“此灵书乃大道之根，还丹之主。有知其音，盖此隐语，非中下士所能颖悟。若至圣大根、神仙种子，得师点破，即解其音。一闻百悟，欣庆无量，更不迟疑，内斋外戒，信受奉行。”
可见，“神仙种子”是类似修仙圣体、悟性极强的意思。
我乃是一个俗居小人，今生有幸入玄门之正教，希望这个网站能从一颗小小的种子开始，生根发芽，帮助更多的人了解道文化。

我不会编程，所幸人工智能技术日新月异，尝试了多种 AI 生成工具、经历了许多失败后，最后用 Cursor 开发环境+ Claude 模型完成了这个网站。本站先从《北斗经》开始，集合经文原文、名家注解、音频、视频、优质公众号文章等，慢慢扩充、成长。
